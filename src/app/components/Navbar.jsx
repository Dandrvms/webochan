    ...
    return (
        <nav className="sticky top-0 z-50 w-full border border-2 bg-gray-800/50 border-gray-800 px-4 py-1">
            <div className="max-w-6xl mx-auto">
                ...
                <a className="text-xs hover:text-black hover:bg-gray-200 active:text-black active:bg-gray-200 px-2" href="/board/webo">[webo]</a>
                <a className="text-xs hover:text-black hover:bg-gray-200 active:text-black active:bg-gray-200 px-2" href="/board/meta">[meta]</a>
                <a className="text-xs hover:text-black hover:bg-gray-200 active:text-black active:bg-gray-200 px-2" href="/board/polls">[polls]</a>
