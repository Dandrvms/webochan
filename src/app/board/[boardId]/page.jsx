        ...
        <>
            ...
            <div className=" flex-col flex items-center w-full h-full pt-10">
                ...
                {boards.includes(boardId) ? (
                    ...
                    <p className="font-bold text-gray-500 leading-none mt-2">{boardId === "webo" ? "Cosas de webo" : boardId === "meta" ? "Sugerencias, Mejoras y Reporte de errores" : boardId === "test" ? "Tablón de pruebas del dev" : null}</p>
                    </>
                ) : (
                    <p className="text-2xl font-bold text-red-500 leading-none">Tablón no encontrado</p>
                )}
